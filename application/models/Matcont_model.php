...
class Matcont_model extends CI_Model {
	...
	public function getMaterialProblem(){

		
		$query = $this->db->query('SELECT * FROM problem WHERE kasus NOT IN("mw","mp","qp","pm") AND (mat IS NULL)');
		
        return $query->result_array();
	}
	
	function updateMaterial($kode,$nilai){
