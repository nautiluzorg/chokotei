...
class Quacont_model extends CI_Model {
	...
	public function getQualityProblem(){
		...
		$query = $this->db->query('SELECT * FROM problem WHERE kasus NOT IN("md","mp") AND (tes IS NULL OR app IS NULL)');
		
        return $query->result_array();
	}
	
	function updateTes($kode,$nilai){
