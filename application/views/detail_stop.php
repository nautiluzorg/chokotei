...
<div class="row">
          ...
          <div class="col-md-6">
              ...
              <div class="pro-img-list">
						...
						<fieldset class="scheduler-border">
							<legend class="scheduler-border text-danger"><?= strtoupper($problem['sub_status']);?></legend>
								<div class="control-group">
										...
										<div class="col-md-4">
												<label class="checkbox-inline">
												  <input type="checkbox" id="cek1" class="abc" value="option1" onClick="return readOnlyCheckBox()" <?= isset($problem['mold']) ? 'checked' : '';?>> MOLD READY
												</label>	
										</div>
										<div class="col-md-4">
												<label class="checkbox-inline">
												  <input type="checkbox" id="cek2" class="abc" value="option2" onClick="return readOnlyCheckBox()" <?= isset($problem['sett']) ? 'checked' : '';?>> SETTING DONE
												</label>
										</div>
										<div class="col-md-4">
												<label class="checkbox-inline">
												  <input type="checkbox" id="cek3" class="abc" value="option3" onClick="return readOnlyCheckBox()" <?= isset($problem['mat']) ? 'checked' : '';?>> MATERIAL
												</label>
										</div>
										<div class="col-md-4">
												<label class="checkbox-inline">
												  <input type="checkbox" id="cek4" class="abc" value="option4" onClick="return readOnlyCheckBox()" <?= isset($problem['tes']) ? 'checked' : '';?>> TESTING 
												</label>
										</div>
										
										<div class="col-md-4">
												<label class="checkbox-inline">
												  <input type="checkbox" id="cek5" class="abc" value="option5" onClick="return readOnlyCheckBox()" <?= isset($problem['app']) ? 'checked' : '';?>>APPROVED
												</label>
										</div>
										<div class="col-md-4">
												<label class="checkbox-inline">
												  <input type="checkbox" id="cek6" class="abc" value="option6" onClick="return readOnlyCheckBox()" <?= isset($problem['man']) ? 'checked' : '';?>> OPERATOR
												</label>
										</div>
          ...
          <div class="col-md-6 bhoechie-tab">
			  ...
			  <dl class="dl-horizontal">
					...
					<div class="product_meta">
						<dt><span> <strong>DATE TIME</strong></span></dt>
						<dd><span class="posted_in"> <strong>:<?= strtoupper($problem["estimate"]);?></strong></span></dd>
					</div>
					 <div class="product_meta">
