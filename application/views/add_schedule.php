...
<input type="hidden" name="status" id="status" value="<?= $status;?>">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="text" name="datetime" id="tglwkt" class="form-control datetime" id="tglwkt" placeholder="Date Time">
    </div>
  </div>
        ...
        $("#submit").on('click',function() {
              ...
              // alert(nilai+" "+kode+" "+qty+" "+tglwkt);
               	...
               	$.ajax({
							...
							type: 'POST',
							data: { 'kode':kode,'status':status, 'draw':draw,'qty':qty,'tglwkt':tglwkt},
							url: '<?= base_url() . 'Welcome/addSchedule' ?>',
							dataType: 'html',
