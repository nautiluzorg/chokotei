            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-home"></i> HOME <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('prodcont'); ?>">DASHBOARD</a></li>
                      <li><a href="<?= base_url('prodcont/profile'); ?>">PROFILE</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-table"></i> DATA MASTER <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('prodcont/drawing');?>">DRAWING NUMBER</a></li>
                      <li><a href="<?= base_url('prodcont/user');?>">USER</a></li>
                     
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> SCHEDULE <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                       <li><a href="<?= base_url('prodcont/jadwal'); ?>">SCHEDULE PLAN</a></li>
                       <li><a href="<?= base_url('prodcont/jaddone');?>">SCHEDULE DONE</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-desktop"></i>LAYOUT MACHINE<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('prodcont/layout1');?>">PLANT 01</a></li>
                      <li><a href="#">PLANT 03</a></li>
                    </ul>
                  </li>
              ...
              <div class="menu_section">
                <h3>REALTIME DATA</h3>
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-bug"></i>REALTIME PROBLEM<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('prodcont/problem');?>">PROBLEM CASE</a></li>
                      <li><a href="<?= base_url('prodcont/status');?>">PROBLEM STATUS</a></li>
