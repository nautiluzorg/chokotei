  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="<?= base_url('prodcont');?>"><i class="fa fa-bars"></i> Main Menu</a></li>
        <li class="dropdown">
...
<div class="col-lg-12 col-md-12 bhoechie-tab-container">
									...
									<div class="row">
										...
										<div class="col-md-12">
												<label class="checkbox-inline">
												  <?= isset($problem['man']) ? "<span class='text-success'><strong><input type='checkbox' disabled='disabled' checked><small>MAN POWER DONE <br>@".$problem['man']."<br> BY PRODUCTION</small></strong></span>" : "<span class='text-danger'><strong><input type='checkbox' disabled='disabled'>MAN POWER ON PROGRESS BY PRODUCTION</strong></span>";?>
												</label>
										</div>
										</div>
          ...
          <div class="col-md-6 bhoechie-tab">
              ...
              <p>
				  <a href="<?= base_url('prodcont/problem');?>"><button type="button" class="btn btn-primary btn-block btn-lg">OK</button></a>
              </p>
