									...
									<div class="row">
										...
										<div class="col-md-4">
												<label class="checkbox-inline">
												  <?= isset($problem['mold']) ? "<span class='text-success'><strong><input type='checkbox' disabled='disabled' checked> PREPARE MOLD DONE <br>@".$problem['mold']."<br> BY TECHNICIAN</strong></span>" : "<span class='text-danger'><strong><input type='checkbox' disabled='disabled'> MOLD ON PROGRESS BY TECHNICIAN</strong></span>";?>
												</label>	
										</div>
										<div class="col-md-4">
												<label class="checkbox-inline">
												  <?= isset($problem['sett']) ? "<span class='text-success'><strong><input type='checkbox' disabled='disabled' checked> SETUP MACHINE DONE <br>@".$problem['sett']."<br> BY TECHNICIAN</strong></span>" : "<span class='text-danger'><strong><input type='checkbox' disabled='disabled'> SETTING MACHINE ON PROGRESS BY TECHNICIAN</strong></span>";?>
												</label>
										</div>
										<div class="col-md-4">
												<label class="checkbox-inline">
												  <?= isset($problem['mat']) ? "<span class='text-success'><strong><input type='checkbox' disabled='disabled' checked> PREPARE MATERIAL DONE <br>@".$problem['mat']."<br> BY MATERIAL</strong></span>" : "<span class='text-danger'><strong><input type='checkbox' disabled='disabled'> MATERIAL ON PROGRESS BY MATERIAL</strong></span>";?>
												</label>
										</div>
										</div>
										...
										<div class="col-md-4">
												<label class="checkbox-inline">
												  <?= isset($problem['tes']) ? "<span class='text-success'><strong><input type='checkbox' disabled='disabled' checked> MEASURING DONE <br>@".$problem['tes']."<br> BY QUALITY</strong></span>" : "<span class='text-danger'><strong><input type='checkbox' disabled='disabled'> MEASURING ON PROGRESS BY QUALITY</strong></span>";?>
												</label>
										</div>
										<div class="col-md-4">
												<label class="checkbox-inline">
												  <?= isset($problem['app']) ? "<span class='text-success'><strong><input type='checkbox' disabled='disabled' checked> APPROVAL DONE <br>@".$problem['app']."<br> BY QUALITY</strong></span>": "<span class='text-danger'><strong><input type='checkbox' disabled='disabled'> APPROVAL ON PROGRESS BY QUALITY</strong></span>";?>
												</label>
										</div>
										<div class="col-md-4">
												<label class="checkbox-inline">
												   <?= isset($problem['man']) ? "<span class='text-success'><strong><input type='checkbox' disabled='disabled' checked> MAN POWER READY <br>@".$problem['man']."<br> BY PRODUCTION</strong></span>" : "<span class='text-danger'><strong><input type='checkbox' disabled='disabled'> MAN POWER ON PROGRESS PRODUCTION</strong></span>";?>
												</label>
										</div>
