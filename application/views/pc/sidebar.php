                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-home"></i> HOME <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('pccont'); ?>">DASHBOARD</a></li>
                      <li><a href="<?= base_url('pccont/profile'); ?>">PROFILE</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-table"></i> MASTER DATA <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('pccont/drawing'); ?>">DRAWING NUMBER</a></li>
                      <li><a href="<?= base_url('pccont/user'); ?>">USER</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> SCHEDULE <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('pccont/add_weekly'); ?>">ADD WEEKLY</a></li>
                      <li><a href="<?= base_url('pccont/jadwal'); ?>">WEEKLY SCHEDULE</a></li>
                      <li><a href="<?= base_url('pccont/jaddone'); ?>">SCHEDULE DONE</a></li>
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-desktop"></i>LAYOUT MACHINE<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('pccont/layout1'); ?>">PLANT 01</a></li>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-bug"></i> PROBLEM CASE <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="#">CURRENT PROBLEM</a></li>
                    </ul>
                  </li>
