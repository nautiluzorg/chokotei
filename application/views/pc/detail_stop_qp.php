									...
									<div class="row">
										...
										<div class="col-md-6">
											<label class="checkbox-inline">
												<?= isset($problem['mold']) ? "<span class='text-success'><strong><input type='checkbox' disabled='disabled' checked> PREPARE MOLD DONE <br>@" . $problem['mold'] . " BY TECHNICIAN</strong></span>" : "<span class='text-danger'><strong><input type='checkbox' disabled='disabled'> MOLD ON PROGRESS BY TECHNICIAN</strong></span>"; ?>
											</label>
										</div>
										<div class="col-md-6">
											<label class="checkbox-inline">
												<?= isset($problem['sett']) ? "<span class='text-success'><strong><input type='checkbox' disabled='disabled' checked> SETUP MACHINE DONE <br>@" . $problem['sett'] . " BY TECHNICIAN</strong></span>" : "<span class='text-danger'><strong><input type='checkbox' disabled='disabled'> SETTING MACHINE ON PROGRESS BY TECHNICIAN</strong></span>"; ?>
											</label>
										</div>
