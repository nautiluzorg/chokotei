	...
	$.fn.dataTableExt.oApi.fnPagingInfo = function(oSettings)
      ...
      var table = $("#mytable").dataTable({
          ...
          initComplete: function() {
              ...
              "serverSide": true,
			  "order":[],
              "ajax": {"url": "<?= base_url('prodcont/get_json_planning')?>", "type": "POST"},
                	"columns": [
												{"data": "id"},
												{"data": "no_mc"},
												{"data": "draw_no"},
...
<form class="form-horizontal" name="formPlanning" method="post" action="<?= base_url('prodcont/addPlanning');?>">
  
   <div class="form-group">
    <label for="inputEmail3" class="col-sm-3 control-label"></label>
    <div class="col-sm-9">
        <a href="<?= base_url('prodcont');?>"><button class="btn btn-sm btn-success" type="button">PLANNING PRODUCTION</button></a>
    </div>
  </div>
  ...
  <div class="form-group">
    <label for="inputPassword3" class="col-sm-3 control-label">Mold</label>
    <div class="col-sm-9">
      
	  	  <select name="mold-no" id="mold-no" class="form-control" required>
				<option value="" disabled selected>-Pilih Mold-</option>
