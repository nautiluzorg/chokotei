        ...
        if ($(this).prop('checked')) {
            ...
            //alert(kode); //checked
				...
				$.ajax({
                            ...
                            dataType:'json',
							url: '<?= base_url() . 'Welcome/updateTestProblem' ?>',
        ...
        if ($(this).prop('checked')) {
            ...
            //alert(kode); //checked
				...
				$.ajax({
                            ...
                            data: { 'kode':kode, 'nilai':nilai},
                            dataType:'json',
							url: '<?= base_url() . 'Welcome/updateAppProblem' ?>',
							success: function(resp) {
											...
											<th scope="row"><?= $row->id_mc;?></th>
												...
												<?php
													  ...
													  if(is_null($row->tes)){ ?>
																...
																<label class="checkbox-inline">
																	<input type="checkbox" class="cekTest" data-id="<?= $row->id;?>" value="<?= date('Y-m-d H:i:s');?>">Done
																</label>
											  ...
											  <td>
													  ...
													  if(is_null($row->app)){ ?>
																...
																<label class="checkbox-inline">
																	<input type="checkbox" class="cekApproval" data-id="<?= $row->id;?>" value="<?= date('Y-m-d H:i:s');?>">Done
																</label>
