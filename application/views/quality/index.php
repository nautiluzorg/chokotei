  ...
  <div class="row" style="display: inline-block;">
    <div class="tile_count">
      <div class="col-md-2  tile_stats_count">
        ...
        <span class="count_bottom"> Install Mold</span>
      </div>
      <div class="col-md-2  tile_stats_count">
        <span class="count_top"> Total</span>
        <div class="count">123</div>
        <span class="count_bottom"> Washing Mold</span>
      </div>
      <div class="col-md-2  tile_stats_count">
        <span class="count_top"> Total</span>
        <div class="count">100</div>
        <span class="count_bottom"> Quality problem</span>
      </div>
      <div class="col-md-2  tile_stats_count">
        <span class="count_top"> Total</span>
        <div class="count">167</div>
        <span class="count_bottom"> Machine Problem</span>
      </div>
      <div class="col-md-2  tile_stats_count">
        <span class="count_top"> Total</span>
        <div class="count">315</div>
        <span class="count_bottom"> Material Delay</span>
      </div>
      <div class="col-md-2  tile_stats_count">
        <span class="count_top"> Total</span>
        <div class="count">215</div>
        <span class="count_bottom"> Man Power</span>
      </div>
    </div>
  </div>
  </div>
    ...
    <div class="col-md-12 col-sm-12 ">
      <div class="dashboard_graph">
        ...
        <div class="row x_title">
          <div class="col-md-6">
            <h3>Graph Activity <small>Problem SPIN</small></h3>
          </div>
          <div class="col-md-6">
        ...
        <div class="col-md-3 col-sm-3  bg-white">
          <div class="x_title">
            <h2>Top Problem SPIN</h2>
            <div class="clearfix"></div>
          </div>

          <div class="col-md-12 col-sm-12 ">
            <div>
              <p>Mold Installation</p>
              <div class="">
