  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="<?= base_url('quacont');?>"><i class="fa fa-bars"></i> Main Menu</a></li>
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="<?= base_url('quacont/profile');?>"><i class="fa fa-user pull-right"></i> Profile</a></li>
...
<div class="col-lg-12 col-md-12 bhoechie-tab-container">
									...
									<div class="row">
										...
										<div class="col-md-6">
												<label class="checkbox-inline">
												  <?= isset($problem['mold']) ? "<span class='text-success'><input type='checkbox' disabled='disabled' checked><strong><small>MOLD PREPARE DONE <br>@".$problem['mold']."<br> BY TECHNICIAN</small></strong></span>" : "<span class='text-danger'><strong><input type='checkbox' disabled='disabled'>MOLD ON PROGRESS BY TECHNICIAN</strong></span>";?>
												</label>	
										</div>
										<div class="col-md-6">
												<label class="checkbox-inline">
												  <?= isset($problem['sett']) ? "<span class='text-success'><strong><input type='checkbox' disabled='disabled' checked><small>MACHINE SETUP DONE <br>@".$problem['sett']."<br> BY TECHNICIAN</small></strong></span>" : "<span class='text-danger'><strong><input type='checkbox' disabled='disabled'>SETUP MACHINE ON PROGRESS BY TECHNICIAN</strong></span>";?>
												</label>
										</div>
										...
										<div class="col-md-6">
												<label class="checkbox-inline">
												  <?= isset($problem['tes']) ? "<span class='text-success'><strong><input type='checkbox' disabled='disabled' checked><small>MEASURING DONE <br>@".$problem['tes']."<br> BY QUALITY</small></strong></span>" : "<span class='text-danger'><strong><input type='checkbox' disabled='disabled'>MEASURING ON PROGRESS BY QUALITY</strong></span>";?>
												</label>
										</div>
										<div class="col-md-6">
												<label class="checkbox-inline">
												  <?= isset($problem['app']) ? "<span class='text-success'><strong><input type='checkbox' disabled='disabled' checked><small>APPROVAL DONE <br>@".$problem['app']."<br> BY QUALITY</small></strong></span>": "<span class='text-danger'><strong><input type='checkbox' disabled='disabled'>APPROVAL ON PROGRESS BY QUALITY</strong></span>";?>
												</label>
										</div>
          ...
          <div class="col-md-6 bhoechie-tab">
              ...
              <p>
				  <a href="<?= base_url('quacont/problem');?>"><button type="button" class="btn btn-primary btn-block btn-lg">OK</button></a>
              </p>
