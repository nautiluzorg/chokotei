                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-home"></i> HOME <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('quacont'); ?>">DASHBOARD</a></li>
                      <li><a href="<?= base_url('quacont/profile'); ?>">PROFILE</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-table"></i> DATA MASTER <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('quacont/drawing');?>">DRAWING NUMBER</a></li>
                      <li><a href="<?= base_url('quacont/user');?>">USER</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-edit"></i> SCHEDULE <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                       <li><a href="<?= base_url('quacont/jadwal'); ?>">SCHEDULE PLAN</a></li>
                       <li><a href="<?= base_url('quacont/jaddone');?>">SCHEDULE DONE</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i>LAYOUT MACHINE<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('quacont/layout1');?>">PLANT 01</a></li>
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-bug"></i> PROBLEM CASE <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('quacont/problem');?>">CURRENT PROBLEM</a></li>
