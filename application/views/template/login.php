        ...
        <div class="animate form login_form">
          <section class="login_content">
            <form>
              ...
              <div>
                <a class="btn btn-info btn-block submit" href="index.html">Log in</a>
                <a href="#signup" class="to_register">Lupa Password Anda?</a>
              </div>

              <div class="clearfix"></div>

              <div class="separator">
                <p class="change_link">Belum Punya Akun? silahkan hubungi IT
                ...
                <div>
                  ...
                  <p>©2022 All Rights Reserved By Sekisui Polymatech Indonesia</p>
                </div>
              </div>
            </form>
          </section>
